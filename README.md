...
### 💻 Desenvolvedor Web Front-End | Estudante de ADS
...
### 🍰 [Zanario Gourmet](https://github.com/devKauaHenrique/zanario-gourmet)
> Cardápio digital e presença online para uma confeitaria real, hospedado na Vercel.
> Em evolução para plataforma completa de gestão: produtos, pedidos, clientes e dashboards.

`HTML` `CSS` `JavaScript` `Vercel`

---

### 🍔 [Dev Burguer](https://github.com/devKauaHenrique/DevBurguer)
> Cardápio virtual para hamburgueria com design responsivo.
